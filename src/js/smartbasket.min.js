document.addEventListener("DOMContentLoaded", function() {
  ...
  t = jQuery, a = {
      ...
      deleteProducts: function(a, s) {
          ...
          }).html('<span class="smart-basket__delete-icon"><i class="fa fa-times" aria-hidden="true"></i></span>');
